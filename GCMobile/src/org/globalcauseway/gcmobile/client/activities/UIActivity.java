...
//    }));
  ...
  private List<Item> createItems() {
    ...
    list.add(new Item("Login with email", UIEntry.EMAIL_LOGIN));
    list.add(new Item("Signup To GC", UIEntry.SIGNUP));
//    list.add(new Item("Elements", UIEntry.ELEMENTS));
//    list.add(new Item("Buttons", UIEntry.HOMEPAGE));
    list.add(new Item("Reset password", UIEntry.PASSWORD_RESET));
//    list.add(new Item("Elements", UIEntry.ELEMENTS));
//    list.add(new Item("Forms", UIEntry.SEARCH));
//    list.add(new Item("Buttons", UIEntry.HOMEPAGE));
