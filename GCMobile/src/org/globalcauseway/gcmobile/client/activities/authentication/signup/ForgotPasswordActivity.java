 ...
 * 
 */
public class ForgotPasswordActivity extends DetailActivity {

	private final ClientFactory clientFactory;

	public ForgotPasswordActivity(ClientFactory clientFactory) {
		super(clientFactory.getSignupView(), "nav");
	...
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		...
		final ForgotPasswordView view = clientFactory.getSignupView();
