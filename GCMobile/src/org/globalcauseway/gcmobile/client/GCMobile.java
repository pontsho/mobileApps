...
import com.googlecode.mgwt.ui.client.theme.mgwt.MGWTColorScheme;
 ...
 * 
 */
public class GCMobile implements EntryPoint {
...
//     MGWTStyle.setTheme(new CustomTheme());
    ...
    AppBundle.INSTANCE.globalStyles().ensureInjected();
    StyleInjector.inject(AppBundle.INSTANCE.globalStyles().getText());
  ...
  private void createPhoneDisplay(ClientFactory clientFactory) {
    ...
    display.asWidget().getElement().setId("main");
